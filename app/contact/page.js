        ...
        <section className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg shadow-lg p-8 mb-12">
          <div className="text-center mb-8">
            ...
            <a
              ...
              download
              className="inline-flex items-center bg-green-700 text-white px-8 py-4 rounded-lg font-semibold hover:bg-green-800 transition-colors shadow-md hover:shadow-lg"
            >
